document.addEventListener('DOMContentLoaded', function() {
    // Initialize the map
    var map = L.map('map').setView([-0.4809153959226429, 35.896187967200576], 11);
    ...
    // Load TIF files
    loadGeoTIFF('http://localhost:8000/raster_img/THEMATIC%20CHANGE%20ANALYSIS%201984%20-%201986.tif', "1986");
    loadGeoTIFF('http://localhost:8000/raster_img/THEMATIC%20CHANGE%20ANALYSIS%201986%20-%201995.tif', "1995");
    loadGeoTIFF('http://localhost:8000/raster_img/THEMATIC%20CHANGE%20ANALYSIS%201995%20-%202002.tif', "2002");
    loadGeoTIFF('http://localhost:8000/raster_img/THEMATIC%20CHANGE%20ANALYSIS%202002%20-%202014.tif', "2014");
    loadGeoTIFF('http://localhost:8000/raster_img/THEMATIC%20CHANGE%20ANALYSIS%202014%20-%202024.tif', "2024");

    // Fetch and display the GeoJSON data
    fetch('./js/eastern_mau_forest_reserve.geojson')
    ...
    function updateLayerTitle(year) {
        ...
        layerTitle = L.control({ position: 'topright', top: '20px' });
